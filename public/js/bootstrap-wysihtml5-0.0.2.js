!function($, wysi) {
	...
	var templates = {
		...
		"link": 	"<li>" 
						...
						+ "<div id='editor-link-modal' class='bootstrap-wysihtml5-insert-link-modal modal fade'>"
				    	...
				    	+ "<a class='btn btn-default' data-toggle='modal' href='#editor-link-modal' data-wysihtml5-command='createLink' title='Link'><i class='fa fa-link'></i></a>" 
