...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '/js/viewer/pdf.worker.js';
  PDFJS.cMapUrl = '/js/viewer/cmaps/';
...
var HOSTED_VIEWER_ORIGINS = ['null',
  'http://mozilla.github.io', 'https://mozilla.github.io', 's3.amazonaws.com'];
...
function webViewerInitialized() {
  ...
  if (file && file.lastIndexOf('file:', 0) === 0) {
    ...
    try {
      xhr.open('GET', file);
	  xhr.setRequestHeader("Origin", 'https://tools.athlosacademies.org');
