...
class TeachersController extends ControllerBase
{
	public function initialize()
	{
		...
		$this->view->setVar("navGroup", "Teachers");
	}
    ...
    public function indexAction()
    {
		...
		$filters = $limitFilter.$schoolFilter.$gradeFilter.$searchFilter;
