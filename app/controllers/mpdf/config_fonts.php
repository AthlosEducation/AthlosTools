...
/* XW Zar Arabic fonts */
	...
	/*-- My Custom Font Additions --*/
	"rockwell" => array(
		'R' => "Rockwell_MT.ttf",
		'unAGlyphs' => true,
		),
	"futura" => array(
		'R' => "Futura Light BT.ttf",
		'B' => "Futura Medium BT.ttf",
		'unAGlyphs' => true,
		),
	"futura-condensed" => array(
		'R' => "Futura Light Condensed BT.ttf",
		'B' => "Futura Medium Condensed BT.ttf",
		'BI' => "Futura Bold Condensed BT.ttf",
		'unAGlyphs' => true,
		),
