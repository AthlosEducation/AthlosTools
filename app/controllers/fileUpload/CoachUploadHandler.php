...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'accept_file_types' => 'Filetype not allowed - CSV files only',
    ...
    function __construct($options = null, $initialize = true, $error_messages = false) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/coachupload',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../app/controllers/fileUpload/files/',
			//'upload_dir' => '/var/www/athlosgrading.decort.net/app/controllers/fileUpload/files/',
            'upload_url' => $this->get_full_url().'/../app/controllers/fileUpload/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
