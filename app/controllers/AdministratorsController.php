...
class AdministratorsController extends ControllerBase
{
	public function initialize()
	{
		...
		$this->view->setVar("navGroup", "Administrators");
	}
    ...
    public function indexAction()
    {
		...
		//-- Grab Super Admin Users Object --//
		$users = Users::find(array("role = 1", "order" => $column." ".$dir, "limit" => array("number" => $limit, "offset" => $offset)));
		$totalUsers = Users::count(array("role = 1", "order" => $column." ".$dir));
		
		//-- Grab Schools --//
		//$schools = Schools::find(array("order" => "state ASC, schoolName ASC"));
		
		//-- Pass Objects / Vars to View --//
        $this->view->setVar("administrators", $users);
