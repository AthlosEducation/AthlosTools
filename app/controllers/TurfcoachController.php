...
class TurfcoachController extends ControllerBase
{
	public function initialize()
	{
		...
		$this->view->setVar("navGroup", "Turfcoach");
	}
    ...
    public function indexAction()
    {
		...
		//-- Grab Turf Coaches Users Object --//
		...
		$gradeList = GradeLevel::find(array("order" => "id ASC"));
		...
		$this->view->setVar("gradeList", $gradeList);
